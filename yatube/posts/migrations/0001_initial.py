# Generated by Django 2.2.16 on 2022-04-10 04:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(help_text='Опустоши свой разум, будь аморфным, бесформенным как вода.', verbose_name='Текст поста')),
